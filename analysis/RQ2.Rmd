...
To answer RQ2, we use four following datasets. 
...
Let's summarize our dataset by key developer, and also preserving 
his / gender and gender group. 
...
### Hypothesis testing about the number of commits. 
...
```{r dunnet-commits}
c<-nparcomp(commits~genderGroup, data=commits_by_user, asy.method = "probit", 
            type = "Dunnett", control = "WKD", alternative = "two.sided", info = FALSE)

summary(c)
```

### Hypothesis testing about the frequency of commits. 
...
### Hypothesis testing about the size of the contributions 
...
### Hypothesis testing about the type of the contributions 

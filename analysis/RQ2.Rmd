...
m_commits_s1_ds$genderGroup <- "MKD-S1"
...
m_commits_s2_ds$genderGroup <- "MKD-S2"
...
bwplot(commits_by_user$commits~commits_by_user$genderGroup, ylab="Total number of contributions (commits)")
...
bwplot(commits_by_user$frequency~commits_by_user$genderGroup, ylab="Frequency of commits")
...
bwplot(log(value)~genderGroup|variable, data=lines,ylab="Lines of Code (log scale)",layout=c(3,1))

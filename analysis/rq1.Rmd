...
```{r hist}
plot(hist(ds_summary$num_tf), xlab = "Number of core developers", main="")
density(ds_summary$num_tf, xlab = "Number of core developers", main="")
...
Now, lets group the core developers by language and gender. 
